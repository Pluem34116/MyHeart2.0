...
public class ChatActivity extends AppCompatActivity {
    String  reciverUid,reciverName,SenderUID = "", myStatus, token, nickname;
    Button stopchat;
            ...
            public void onClick(View view) {
                FCMSend.pushNotification(
                        ChatActivity.this,
                            //เก็บไว้อ่าน
//                        nickname,
//                        nickname = "ผู้รับต้องการคำปรึกษา"+getIntent().getStringExtra("nickname")+"กรุณาเข้าแอพเพื่อให้คำปรึกษา"
                        token,
